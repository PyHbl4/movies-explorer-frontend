        ...
        <main className='main auth'>
            <section className='sign-up'>
                ...
                <form action='POST' className='form register-form'>
                    ...
                    <input type="text" className='form__input' id='name' name='name' placeholder='Ваше имя' required minLength={2} maxLength={30}></input>
                    ...
                    <input type="password" className='form__input' id='password' name='password' placeholder='Придумайте пароль' required minLength={8}></input>
